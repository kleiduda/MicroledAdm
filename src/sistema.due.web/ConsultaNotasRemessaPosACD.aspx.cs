    ...
    public partial class ConsultaNotasRemessaPosACD : System.Web.UI.Page
    {
        ...
        private static void ConsultaPosACDAsync(List<string> notasFiscaisFiltro, string guid, int usuarioId, string sessionFiltroChavesRemessaUpload)
        {
            ...
            foreach (DataRow rowRemessa in dataTableRemessa.Rows)
            {
                ...
                camposNFRemessa.DataDUE = camposRemessa.ElementAt(1);
                camposNFRemessa.DUE = camposRemessa.ElementAt(2);
                camposNFRemessa.ChaveDUE = camposRemessa.ElementAt(3);
                camposNFRemessa.DeclaranteCnpj = camposRemessa.ElementAt(4);
                camposNFRemessa.DeclaranteNome = camposRemessa.ElementAt(5);
                camposNFRemessa.UltimoEvento = camposRemessa.ElementAt(6);
                camposNFRemessa.DataUltimoEvento = camposRemessa.ElementAt(7);
                camposNFRemessa.DataAverbacao = camposRemessa.ElementAt(8);
                camposNFRemessa.RUC = camposRemessa.ElementAt(9);
                camposNFRemessa.Porto = camposRemessa.ElementAt(10);
                camposNFRemessa.Recinto = camposRemessa.ElementAt(11);
                camposNFRemessa.Canal = camposRemessa.ElementAt(12);
                camposNFRemessa.CPFRegistroDue = camposRemessa.ElementAt(13);
                camposNFRemessa.DataEmbarque = camposRemessa.ElementAt(14);
                camposNFRemessa.DataDesembaraco = camposRemessa.ElementAt(15);
                camposNFRemessa.ComissaoAgente = camposRemessa.ElementAt(16);
                camposNFRemessa.ItemDUE = camposRemessa.ElementAt(17);
                camposNFRemessa.NCM = camposRemessa.ElementAt(18);
                camposNFRemessa.ItemNF = camposRemessa.ElementAt(19);
                camposNFRemessa.CFOP = camposRemessa.ElementAt(20);
                camposNFRemessa.DESCRICAO = camposRemessa.ElementAt(21);
                camposNFRemessa.TipoNF = camposRemessa.ElementAt(22);
                camposNFRemessa.ChaveNF = camposRemessa.ElementAt(23);
                camposNFRemessa.NUMERO = camposRemessa.ElementAt(24);
                camposNFRemessa.MODELO = camposRemessa.ElementAt(25);
                camposNFRemessa.SERIE = camposRemessa.ElementAt(26);
                camposNFRemessa.UF = camposRemessa.ElementAt(27);
                camposNFRemessa.CNPJEmitente = camposRemessa.ElementAt(28);
                camposNFRemessa.EventoAverbacao = camposRemessa.ElementAt(29);
                camposNFRemessa.VMLE = camposRemessa.ElementAt(30);
                camposNFRemessa.ValorEmReais = camposRemessa.ElementAt(31);
                camposNFRemessa.VMCV = camposRemessa.ElementAt(32);
                camposNFRemessa.IMPORTADOR = camposRemessa.ElementAt(33);
                camposNFRemessa.ImportadorEndereco = camposRemessa.ElementAt(34);
                camposNFRemessa.ImportadorPais = camposRemessa.ElementAt(35);
                camposNFRemessa.PaisDestino = camposRemessa.ElementAt(36);
                camposNFRemessa.Unidade = camposRemessa.ElementAt(37);
                camposNFRemessa.PesoLiquidoTotal = camposRemessa.ElementAt(38);
                camposNFRemessa.Moeda = camposRemessa.ElementAt(39);
                camposNFRemessa.INCOTERM = camposRemessa.ElementAt(40);
                camposNFRemessa.InformacoesComplementares = camposRemessa.ElementAt(41);
                camposNFRemessa.UnidadeRFB = camposRemessa.ElementAt(42);
                camposNFRemessa.DescricaoUnidadeRFB = camposRemessa.ElementAt(43);
                camposNFRemessa.RecintoDespacho = camposRemessa.ElementAt(44);
                camposNFRemessa.DescricaoRecintoDespacho = camposRemessa.ElementAt(45);
                camposNFRemessa.QuantidadeNF = camposRemessa.ElementAt(46);
                camposNFRemessa.QuantidadeAverbada = camposRemessa.ElementAt(47);
        ...
        protected void btnGerarCsvAux_Click(object sender, EventArgs e)
        {
            ...
            colunas.Add("Recinto");
            colunas.Add("Canal");
            colunas.Add("CPFRegistroDue");
            colunas.Add("DataEmbarque");
            colunas.Add("DataDesembaraco");
            colunas.Add("ComissaoAgente");
            ...
            if (listaResultadosSiscomex != null)
            {
                ...
                {
                    rows.Add("As notas abaixo não formam encontradas no banco de dados de DUEs e os dados apresentados foram consultados diretamente no SISCOMEX");
                }
            }
