                    ...
                    Cmd.CommandText = $@"
                            SELECT
                                DISTINCT
                                  ...
                                  ,B.RUC
                                  ,B.PORTO as Porto
                                  ,B.RECINTO as Recinto
                                  ,B.CANAL as Canal
                                  ,B.CPF_REGISTRO_DUE as CPFRegistroDue
                                  ,B.DATA_EMBARQUE as DataEmbarque
                                  ,B.DATA_DESEMBARACO as DataDesembaraco
            
                                  ,A.COMISSAOAGENTE as ComissaoAgente
                ...
                using (SqlCommand Cmd = new SqlCommand())
                {
                    ...
                    Cmd.CommandText = $@"
                            SELECT
                                ...
                                ,C.RUC
                                ,C.PORTO as Porto
                                ,C.RECINTO as Recinto
                                ,C.CANAL as Canal
                                ,C.CPF_REGISTRO_DUE as CPFRegistroDue
                                ,C.DATA_EMBARQUE as DataEmbarque
                                ,C.DATA_DESEMBARACO as DataDesembaraco
