...
namespace Sistema.DUE.Web
{
    public partial class ConsultaEstoquePosACDComNotasRemessa : System.Web.UI.Page
    {
        ...
        private string GerarFiltro()
        {
            ...
            if (!string.IsNullOrEmpty(this.txtDataAverbacaoDe.Text))
            {
                if (StringHelpers.IsDate(this.txtDataAverbacaoDe.Text))
                {
                    filtro.Append(" AND A.DATA_AVERBACAO >= CONVERT(DATETIME,'" + Convert.ToDateTime(this.txtDataAverbacaoDe.Text).ToString("dd/MM/yyyy") + " 00:00:00', 103) ");
                }
            }

            if (!string.IsNullOrEmpty(this.txtDataAverbacaoAte.Text))
            {
                if (StringHelpers.IsDate(this.txtDataAverbacaoAte.Text))
                {
                    filtro.Append(" AND A.DATA_AVERBACAO <= CONVERT(DATETIME,'" + Convert.ToDateTime(this.txtDataAverbacaoAte.Text).ToString("dd/MM/yyyy") + " 23:59:59', 103) ");
                }
            }
        ...
        protected void btnGerarCsv_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.txtDataAverbacaoDe.Text))
            {
                if (StringHelpers.IsDate(this.txtDataAverbacaoDe.Text))
                {
                    filtro.Append(" AND B.DATA_AVERBACAO >= CONVERT(DATETIME,'" + Convert.ToDateTime(this.txtDataAverbacaoDe.Text).ToString("dd/MM/yyyy") + " 00:00:00', 103) ");
                }
            }
            ...
            if (!string.IsNullOrEmpty(this.txtDataAverbacaoAte.Text))
            {
                if (StringHelpers.IsDate(this.txtDataAverbacaoAte.Text))
                {
                    filtro.Append(" AND B.DATA_AVERBACAO <= CONVERT(DATETIME,'" + Convert.ToDateTime(this.txtDataAverbacaoAte.Text).ToString("dd/MM/yyyy") + " 23:59:59', 103) ");
                }
            }
