<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaEstoquePosACD.aspx.cs" Inherits="Sistema.DUE.Web.ConsultaEstoquePosACD" %>
...
<%--                    <li class="active"><a href="VincularDUENF.aspx"><i class="fa fa-cogs"></i>&nbsp;Víncular DUE com NF</a></li>--%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Estoque Pós ACD somente notas exportação</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row no-gutter">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label class="control-label">Data Averbação (De):</label>
                                        <asp:TextBox ID="txtDataAverbacaoDe" runat="server" CssClass="form-control form-control-sm data"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label class="control-label">Data Averbação (Até):</label>
                                        <asp:TextBox ID="txtDataAverbacaoAte" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
    ...
    <div id="footer" class="container">
        <nav class="navbar navbar-inverse navbar-fixed-bottom navbar-custom">
            <div class="navbar-inner navbar-content-center">
                <p class="text-muted text-center"><asp:Label ID="lblRazaoEmpresa" runat="server" Text=""></asp:Label> <%= DateTime.Now.Year %></p>
            </div>
        </nav>
    </div>
    ...
    <script>
        ...
        $('#txtDataAverbacaoDe').mask('00/00/0000');
        $('#txtDataAverbacaoAte').mask('00/00/0000');
