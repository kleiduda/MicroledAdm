namespace Cargill.DUE.Web.Models.SERPRO.xml
{
    ...
    public partial class ResultadoConsultaXML
    {
    ...
    public partial class nfeConsultaNFeLogResultRetConsNFeLogNFeLogProcEventoNFeEventoInfEventoDetEventoItensAverbados
    {
        ...
        private System.DateTime dhEmbarqueField;

        private byte motAlteracaoField;

        private System.DateTime dhAverbacaoField;

        private byte nItemDueField;

        private decimal qItemField;
        ...
        /// <remarks/>
        public System.DateTime dhEmbarque
        {
            get
            {
